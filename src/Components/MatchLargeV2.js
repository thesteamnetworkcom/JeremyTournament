			...
			<div className={classes.teams}>
				<div className={classes.team + ' ' + classes.padright}>
					...
					<div className={classes.winsForeground}>
						<div className={classes.plus} onClick={(event)=>handleChange("player1wins","plus")}></div>
						<div className={classes.minus} onClick={(event)=>handleChange("player1wins","minus")}></div>
					</div>
				</div>
				<div className={classes.team + ' ' + classes.padleft}>
					...
					<div className={classes.winsForeground}>
						<div className={classes.plus} onClick={(event)=>handleChange("player2wins","plus")}></div>
						<div className={classes.minus} onClick={(event)=>handleChange("player2wins","minus")}></div>
					</div>
				</div>
			</div>
		</div>
