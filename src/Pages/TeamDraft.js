...
const ConnectedTeamDraft = (props) => {
	...
	return(
		<div className={classes.fullScreen}>
			...
			<>
			<Button color="primary" variant="contained" className={classes.fullWidth + ' ' + classes.bottomSpace} onClick={()=>props.clearTeams()}>CLEAR TEAMS</Button>
			...
			<Button color="primary" variant="contained" className={classes.fullWidth + ' ' + classes.topSpace} onClick={()=>
		{		
			props.submit(props.players)
			props.schedule()
		}}>
				Submit
			</Button>
